...
//        }
	Log::Debug("DataAccess/LogAggregator:construct start:%s end:%s", $this->dateStart->getDatetime(), $this->dateEnd->getDatetime());
...
//        $bind = array($start, $end);
	...
	Log::Debug("DataAccess/LogAggregator:getGeneralQueryBindParams %s %s %s", $this->period->getLabel(), $start, $end);
	$bind = array($start, $end);
...
*/
	...
	Log::Debug("DataAccess/LogAggregator:queryActionsByDimension: table:%s", $tableName);
